...
echo '<table border="0">'.'<td style="width:100px" height="200" align="left">'
  . $row["name"]
  .'<td >'
...
<th style="width:145px">PostCode</th>
							...
							<tr>
								...
								<tr>
									...
									<tr>
										<td></td>
										<td>
										<input type="submit" value="Create User" onSubmit="window.location.reload()" />
										</td>
								</form>
							</table>
